...
set _ext_classes=%IMQ_EXTERNAL%\jndifs\lib\fscontext.jar;%IMQ_EXTERNAL%\javahelp-S9\SUNWjhrt\reloc\j2se\opt\javahelp\jhall.jar
...
REM
set _classes=%_IMQ_HOME%/../../share/opt/classes;%_IMQ_HOME%\lib\help;%_ext_classes%;%CLASSPATH%

goto resume2

:noclasspath
set _classes=%_IMQ_HOME%/../../share/opt/classes;%_IMQ_HOME%\lib\help;%_ext_classes%
