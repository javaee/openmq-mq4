...
public class BridgeMgrStatusEvent extends CommonCmdStatusEvent {
    ...
    public enum Type {
        ;
        protected final static int HELLO  = 5000;
        protected final static int LIST   = 5001;
        protected final static int START  = 5002;
        protected final static int STOP   = 5003;
        protected final static int RESUME = 5004;
        protected final static int PAUSE  = 5005;
        protected final static int DEBUG  = 5006;
    }
