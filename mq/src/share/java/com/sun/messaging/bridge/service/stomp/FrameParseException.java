...
public class FrameParseException extends Exception{
    ...
    public static StompFrameMessage OOMMSG = null; 

    static {
        OOMMSG = new StompFrameMessage(StompFrameMessage.Command.ERROR);
        OOMMSG.addHeader(StompFrameMessage.ErrorHeader.MESSAGE, "OutOfMemoryError");
    ...
    public FrameParseException(String message, boolean fatal) {
        super(message);
        _fatal = fatal;
    }

    public FrameParseException(String message, Throwable t) {
        this(message, t, false);
    }

    public FrameParseException(String message, Throwable t, boolean fatal) {
        super(message, t);
        _fatal = fatal;
    }
    ...
    public StompFrameMessage getStompMessageERROR() throws Exception {
        ...
        StompFrameMessage msg = new StompFrameMessage(StompFrameMessage.Command.ERROR);
        if (_fatal) msg.setFatalERROR();
