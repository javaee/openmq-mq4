   ...
   //static final int AUTO_ACKNOWLEDGE = 1;
    ...
    protected void acknowledgeExpired(MessageImpl message, boolean prefetch) throws JMSException {
        ...
        try {
            ...
            protocolHandler.acknowledgeExpired(expirePkt, true);
            ...
            String estr =  AdministeredObject.cr.getKString(
                ClientResources.X_EXPIRE_MESSAGE_BEFORE_DELIVERY, args);
            JMSException jmse = new JMSException(estr, ClientResources.X_EXPIRE_MESSAGE_BEFORE_DELIVERY);
