...
class TransactionDAOImpl extends BaseDAOImpl implements TransactionDAO {
            ...
            try {
                ...
                try {
                    ...
                    logger.log( Logger.ERROR, br.getKString(
                        ...
                        "Checking existence of txn" + txnUID ), e2 );
                }
        ...
        try {
            ...
            if ( e instanceof BrokerException ) {
                ...
                ex = DBManager.wrapSQLException("[" +
                    selectRemoteTxnStatesByBrokerAndTypeSQL + "]", (SQLException)e);
            } else {
                ex = e;
            }
     ...
     */
    public HashMap getTransactionStatesByBroker( Connection conn, String brokerID )
        throws BrokerException {
     ...
     *  an empty Map is returned if no transactions exist in the store
     */
    public HashMap getRemoteTransactionStatesByBroker( Connection conn, String brokerID )
        throws BrokerException {
