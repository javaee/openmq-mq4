...
public class ClusterReplicationGroupInfo implements ClusterProtocolHelper
{
    ...
    private ClusterReplicationGroupInfo(String groupName, String nodeName,
                                        String masterHostPort,  Integer replicaPort,
                                        Cluster c) {
    ...
    public static ClusterReplicationGroupInfo newInstance(
                      ...
                      String masterHostPort, Integer replicaPort, Cluster c) {
        return new ClusterReplicationGroupInfo(groupName, nodeName,
                                     masterHostPort, replicaPort, c);
    }
    ...
    public GPacket getGPacket() throws IOException { 
        ...
        gp.putProp("replicaPort", replicaPort);
    ...
    public Integer getReplicaPort() {
        assert ( pkt != null );
        return (Integer)pkt.getProp("replicaPort");
    }
    ...
    public String toString() {
        ...
        if (pkt == null) {
            return "["+groupName+"["+nodeName+", "+masterHostPort+"]"+replicaPort+"]";
        } 
        return "["+getGroupName()+"["+getNodeName()+", "+getMasterHostPort()+"]"+getReplicaPort()+", "+getTimestamp()+"]";
    }
}
