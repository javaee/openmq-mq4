...
/*
 * @(#)HADBConfigRecordDAOImpl.java	1.3 06/29/07
 */ 
...
/**
 * This class implements ConfigRecordDAO interface for HADB.
 */
class HADBConfigRecordDAOImpl extends ConfigRecordDAOImpl {

    /**
     * Constructor
     * @throws com.sun.messaging.jmq.jmsserver.util.BrokerException
     */
    HADBConfigRecordDAOImpl() throws BrokerException {
