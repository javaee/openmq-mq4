...
/*
 * @(#)MessageNotWriteableException.java	1.4 07/02/07
 */ 
...
public class MessageNotWriteableException extends javax.jms.MessageNotWriteableException
             implements Loggable {
  ...
  /** Constructs a <CODE>MessageNotWriteableException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>MessageNotWriteableException</CODE> with the specified reason and with
   ...
   **/
  public
  MessageNotWriteableException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>MessageNotWriteableException</CODE>.
   * When a backtrace of the <CODE>MessageNotWriteableException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>MessageNotWriteableException</CODE> and obtained via
