...
/*
 * @(#)TransactionRolledBackException.java	1.4 07/02/07
 */ 
...
public class TransactionRolledBackException extends javax.jms.TransactionRolledBackException
             implements Loggable {
  ...
  /** Constructs a <CODE>TransactionRolledBackException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>TransactionRolledBackException</CODE> with the specified reason and with
   ...
   **/
  public
  TransactionRolledBackException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>TransactionRolledBackException</CODE>.
   * When a backtrace of the <CODE>TransactionRolledBackException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>TransactionRolledBackException</CODE> and obtained via
