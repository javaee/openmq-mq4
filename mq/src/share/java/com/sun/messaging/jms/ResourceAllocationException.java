...
public class ResourceAllocationException extends javax.jms.ResourceAllocationException
             implements Loggable {
  ...
  /** Constructs a <CODE>ResourceAllocationException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>ResourceAllocationException</CODE> with the specified reason and with
   ...
   **/
  public
  ResourceAllocationException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>ResourceAllocationException</CODE>.
   * When a backtrace of the <CODE>ResourceAllocationException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>ResourceAllocationException</CODE> and obtained via
