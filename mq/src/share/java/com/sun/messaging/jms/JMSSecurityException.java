...
/*
 * @(#)JMSSecurityException.java	1.4 07/02/07
 */ 
...
public class JMSSecurityException extends javax.jms.JMSSecurityException
             implements Loggable {
  ...
  /** Constructs a <CODE>JMSSecurityException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>JMSSecurityException</CODE> with the specified reason and with
   ...
   **/
  public
  JMSSecurityException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>JMSSecurityException</CODE>.
   * When a backtrace of the <CODE>JMSSecurityException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>JMSSecurityException</CODE> and obtained via
