...
/*
 * @(#)InvalidClientIDException.java	1.4 07/02/07
 */ 
...
public class InvalidClientIDException extends javax.jms.InvalidClientIDException
             implements Loggable {
  ...
  /** Constructs a <CODE>InvalidClientIDException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>InvalidClientIDException</CODE> with the specified reason and with
  ...
  /** Constructs a <CODE>InvalidClientIDException</CODE> with the specified reason,
   ...
   **/
  public
  InvalidClientIDException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>InvalidClientIDException</CODE>.
   * When a backtrace of the <CODE>InvalidClientIDException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>InvalidClientIDException</CODE> and obtained via
