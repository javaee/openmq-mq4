...
public class MessageEOFException extends javax.jms.MessageEOFException
             implements Loggable {
  ...
  /** Constructs a <CODE>MessageEOFException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>MessageEOFException</CODE> with the specified reason and with
   ...
   **/
  public
  MessageEOFException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>MessageEOFException</CODE>.
   * When a backtrace of the <CODE>MessageEOFException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>MessageEOFException</CODE> and obtained via
