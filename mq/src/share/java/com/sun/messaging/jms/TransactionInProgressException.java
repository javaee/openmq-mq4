...
public class TransactionInProgressException extends javax.jms.TransactionInProgressException
             implements Loggable {
  ...
  /** Constructs a <CODE>TransactionInProgressException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>TransactionInProgressException</CODE> with the specified reason and with
   ...
   **/
  public
  TransactionInProgressException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>TransactionInProgressException</CODE>.
   * When a backtrace of the <CODE>TransactionInProgressException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>TransactionInProgressException</CODE> and obtained via
