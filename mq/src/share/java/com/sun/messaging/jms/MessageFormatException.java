...
public class MessageFormatException extends javax.jms.MessageFormatException
             implements Loggable {
  ...
  /** Constructs a <CODE>MessageFormatException</CODE> with the specified reason and
   *  error code.
   *
  ...
  /** Constructs a <CODE>MessageFormatException</CODE> with the specified reason and with
   ...
   **/
  public
  MessageFormatException(String reason, String errorCode, Throwable cause) {
    super(reason, errorCode);
    this.cause = cause;
   ...
   * set the cause of the <CODE>MessageFormatException</CODE>.
   * When a backtrace of the <CODE>MessageFormatException</CODE> is printed
  ...
  **/
   ...
   * to this <CODE>MessageFormatException</CODE> and obtained via
